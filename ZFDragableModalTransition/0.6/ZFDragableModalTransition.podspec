...
Pod::Spec.new do |s|
  ...
  s.homepage         = "https://github.com/wangkaird/ZFDragableModalTransition"
  s.license          = 'MIT'
  s.author           = { "Amornchai Kanokpullwad" => "amornchai.zoon@gmail.com" }
  s.source           = { :git => "https://github.com/wangkaird/ZFDragableModalTransition.git", :tag => s.version.to_s }
